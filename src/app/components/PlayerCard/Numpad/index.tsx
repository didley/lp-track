  ...
  return (
    <Portal rootId="numpad-root">
      <div className="absolute h-screen w-screen flex">
        ...
        >
          <div className="bg-black h-28 m-4 p-4 rounded-xl text-white text-4xl">
            {currentLp} {calculation} {pendingVal}
          </div>
          <div className="grid grid-cols-4 grid-rows-5 place-items-center gap-2 m-3">
            {keys.map((key) => (
              <NumpadBtn
      ...
      <div className="absolute h-screen w-screen z-10" onClick={hideNumpad} />
    </Portal>
  );
};
